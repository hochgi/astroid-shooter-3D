...
public class Explosion {
	...
	public Explosion(Vector pos, Orientation camera) {
		...
		SpriteEmitter.registerObject(shockwave);
		...
		SpriteEmitter.registerObject(flash1);
		SpriteEmitter.registerObject(flash2);
		SpriteEmitter.registerObject(flash3);
		SpriteEmitter.registerObject(flash4);
	}
