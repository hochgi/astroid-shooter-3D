...
import com.biu.cg.objects3d.TempShip;
...
public class Game extends MultiKeysAdapter implements GLEventListener {
	...
	private Orientation orientation = new Orientation(new Vector(0,5,-5),
			  										  new Vector(1,0,0), 
			  										  new Vector(0,1,0),
													  new Vector(0,0,1));
...
//		tetra = Tetrahedron.createTetrahedron(new Vector(0f,1f*expansionFactor,0f), new Vector(0f,1f,0f).normalize(), pTheta * 2f, 25f);
		...
		michael = new TempShip(new Vector(0,2,5), orientation);
